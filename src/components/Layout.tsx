...
export default function Layout({ children, currentPage, onNavigate, headerExtra }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="text-[9px] text-ast-text3 tracking-[2px] uppercase px-5 pt-3.5 pb-1.5">Atividades</div>
